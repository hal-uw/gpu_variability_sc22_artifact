...
if [[ "$uarch" == *ppc64le* ]]; then
    ...
    singularity run --nv cuda-mpich-base_3.1.4_cuda10.2-devel_ubuntu18.04.sif ./build-lammps.sh 
    mpirun -n 1 singularity run --nv cuda-mpich-base_3.1.4_cuda10.2-devel_ubuntu18.04.sif ./run-lammps.sh 0 1 0  
fi
